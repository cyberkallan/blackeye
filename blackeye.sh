#!/bin/bash
# BLACKEYE v1.1 is an upgrade from original ShellPhish Tool under GNU LICENSE 
# Coded by: Cyber kallan (https://github.com/cyberkallan/blackeye) Give me the credits if copy ANY part from this code. Don't be NOOB!!
# Upgraded by: arjun arz  (Youtube/Cyber kallan)
# Credits (Copyright)
# Phishing Pages generated by An0nUD4Y :(https://github.com/cyberkallan)
# Instagram
...
# Phishing Pages generated by @cyber kallan  (https://github.com/cyberkallan/blackeye):
...
printf "\e[1;92m[\e[0m\e[1;77m16\e[0m\e[1;92m]\e[0m\e[1;91m Microsoft\e[0m      \e[1;92m[\e[0m\e[1;77m32\e[0m\e[1;92m]\e[0m\e[1;91m devianART   \e[0m           \e[1;94m CODED BY: ꧁༺𝒄𝒚𝒃𝒆𝒓 𝒌𝒂𝒍𝒍𝒂𝒏༻꧂\e[0m\n"

printf "                                                \e[1;94m UPGRADED BY:Ar̼̯̤̈ͭ̃ͨ̆j͇̗̲̞̪̹̝̫̞ͬ͐̀ͧ̿u̟͎̲͕̼̳͉̲ͮͫͭ̋ͭ͛ͣ̈n͉̠̙͉̗̺̋̋̔ͧ̊ a̘̫͈̭͌͛͌̇̇̍r̼̯̤̈ͭ̃ͨ̆z̼͖̺̠̰͇̙̓͛ͮͩͦ̎ͦ̑ͅ \e[0m\n"
